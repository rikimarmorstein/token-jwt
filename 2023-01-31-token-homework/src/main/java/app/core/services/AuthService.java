...
public class AuthService {
	...
	public String login(UserCredentials userCredentials) throws LoginException {
		User user = this.userRepo.findByName(userCredentials.getName()).orElseThrow(
				() -> new AuthException("loging failed - user with name " + userCredentials.getName() + " not found"));
